/*
	This function returns a empty chart object, which can be bound to an html unit
	A chart contains a model and A model contains the logic for data binding and html rendering via d3.js
...
nv.models.multiBarChart = function() {
  ...
  /* set the display parameters of this chart */
  ...
  /* Create a multi bar object model */
  ...
  /* Set the display format for axis ticks */ 	  
  xAxis.tickFormat(function(d) { return d });
  yAxis.tickFormat(d3.format(',.1f'));

  /* A function to display the tooltip */
  ...
  /* Set the different options for the controls buttons, here Grouped is the default and Stacked is disabled */
  var controlsData = [
    { key: 'Grouped' },
  ...
  /* 
	This is the main function that returns the chart, it uses all of the above functions to create a chart object element
	Selection is the selected Dom element, something like ~  d3.select('#chart1 svg') ~
  */
